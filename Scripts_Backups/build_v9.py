...
<head>
    ...
    <title>AMMAR PerfumerÃ­a | By Karen Rico</title>
    ...
    button[onclick="toggleTheme()"] { display: none !important; }</style>
</head>
<body class="antialiased min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="#" onclick="navigate('catalogo')" class="nav-link nav-catalogo text-sm tracking-widest uppercase hover:text-gold transition px-2 py-1">CatÃ¡logo</a>
    ...
    <div id="mobileMenu" class="fixed inset-0 z-40 bg-dark/95 backdrop-blur-lg transform translate-x-full transition-transform duration-300 pt-24 px-8">
        ...
        <div class="flex flex-col space-y-6 text-center">
            ...
            <a href="#" onclick="navigate('catalogo'); toggleMenu()" class="text-2xl font-cinzel text-white hover:text-gold">CatÃ¡logo</a>
    ...
    <main class="flex-grow">
        ...
        <div id="home" class="page active">
            ...
            <div class="relative h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div class="relative z-10 text-center px-4">
                    ...
                    <button onclick="navigate('catalogo')" class="bg-gold text-dark font-semibold px-8 py-3 uppercase tracking-widest hover:bg-white transition duration-300">Explorar CatÃ¡logo</button>
                </div>
            </div>
            ...
            <div class="py-16 border-b border-white/5">
                <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
                    <div>
                        <div class="text-gold text-4xl mb-4">âœ¨</div>
                    ...
                    <div>
                        <div class="text-gold text-4xl mb-4">ðŸšš</div>
                        <h3 class="font-cinzel font-bold mb-2">EnvÃ­o Nacional</h3>
                        <p class="text-sm opacity-70">EnvÃ­os seguros a toda Colombia.</p>
                    </div>
                    <div>
                        <div class="text-gold text-4xl mb-4">ðŸ’Ž</div>
                        <h3 class="font-cinzel font-bold mb-2">Marcas Exclusivas</h3>
                        <p class="text-sm opacity-70">SelecciÃ³n premium de las mejores casas perfumeras.</p>
                    </div>
                    <div>
                        <div class="text-gold text-4xl mb-4">ðŸ”’</div>
                        <h3 class="font-cinzel font-bold mb-2">Pago Seguro</h3>
                        <p class="text-sm opacity-70">MÃºltiples medios de pago 100% confiables.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="py-20 max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="font-cinzel text-3xl md:text-4xl font-bold mb-4">SelecciÃ³n <span class="text-gold">Destacada</span></h2>
            ...
            <div class="py-20 bg-cardDark border-t border-white/5">
                <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 class="font-cinzel text-3xl font-bold mb-6">VisÃ­tanos en <span class="text-gold">MedellÃ­n</span></h2>
                        <p class="mb-4 flex items-center"><span class="text-gold mr-3">ðŸ“</span> Cra. 86b #47a-40, Barrio Floresta, MedellÃ­n, Antioquia</p>
                        <p class="mb-4 flex items-center"><span class="text-gold mr-3">ðŸ•’</span> Lunes a SÃ¡bado: 9am - 7pm<br>Domingos: 10am - 3pm</p>
                        <p class="mb-8 flex items-center"><span class="text-gold mr-3">ðŸ“±</span> +57 312 858 6188</p>
        ...
        <div id="catalogo" class="page py-12">
            <div class="max-w-7xl mx-auto px-4">
                <h2 class="font-cinzel text-4xl font-bold mb-8 text-center">Nuestro <span class="text-gold">CatÃ¡logo</span></h2>
                ...
                <div class="bg-cardDark p-6 rounded-lg mb-8 border border-white/5">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <select id="genderFilter" class="bg-dark border border-white/10 p-3 rounded text-light focus:border-gold focus:outline-none w-full">
                            <option value="">Cualquier GÃ©nero</option>
                        </select>
                ...
                <!-- Load More -->
                <div class="text-center mt-12">
                    <button id="loadMoreBtn" class="bg-gold text-dark font-semibold px-8 py-3 uppercase tracking-widest hover:bg-white transition duration-300 hidden">Cargar MÃ¡s</button>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div class="card rounded-xl overflow-hidden cursor-pointer group">
                        <div class="h-64 overflow-hidden relative">
                            ...
                            <span class="absolute top-4 left-4 bg-gold text-dark text-xs font-bold px-3 py-1 uppercase tracking-wider">GuÃ­a</span>
                        </div>
                        <div class="p-8">
                            <p class="text-sm opacity-60 mb-2">15 Septiembre, 2026</p>
                            <h3 class="font-cinzel text-2xl font-bold mb-3 group-hover:text-gold transition">CÃ³mo elegir tu fragancia firma</h3>
                            <p class="opacity-80 font-playfair line-clamp-3">Encontrar el perfume que te defina no es tarea fÃ¡cil. Requiere entender tu quÃ­mica corporal, tu personalidad y las familias olfativas...</p>
                        </div>
                    </div>
                    <!-- Article 2 -->
                    <div class="card rounded-xl overflow-hidden cursor-pointer group">
                        ...
                        <div class="p-8">
                            ...
                            <h3 class="font-cinzel text-2xl font-bold mb-3 group-hover:text-gold transition">Las notas de madera en otoÃ±o</h3>
                            <p class="opacity-80 font-playfair line-clamp-3">El sÃ¡ndalo, el cedro y el oud toman protagonismo esta temporada. Descubre por quÃ© las fragancias amaderadas son perfectas para el clima frÃ­o.</p>
                        </div>
                    </div>
                    <!-- Article 3 -->
                    <div class="card rounded-xl overflow-hidden cursor-pointer group">
                        ...
                        <div class="p-8">
                            ...
                            <p class="opacity-80 font-playfair line-clamp-3">Un viaje a travÃ©s del tiempo hacia Grasse, la cuna mundial de la perfumerÃ­a, y cÃ³mo revolucionÃ³ la industria para siempre.</p>
                        </div>
                    </div>
                    <!-- Article 4 -->
                    <div class="card rounded-xl overflow-hidden cursor-pointer group">
                        ...
                        <div class="p-8">
                            ...
                            <h3 class="font-cinzel text-2xl font-bold mb-3 group-hover:text-gold transition">Secretos para que tu perfume dure todo el dÃ­a</h3>
                            <p class="opacity-80 font-playfair line-clamp-3">Â¿Sientes que tu fragancia desaparece rÃ¡pido? Aplica estos sencillos trucos en los puntos de pulso y maximiza la fijaciÃ³n.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="contacto" class="page py-12">
            <div class="max-w-7xl mx-auto px-4">
                <h2 class="font-cinzel text-4xl font-bold mb-12 text-center">ContÃ¡ctanos</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="bg-cardDark p-8 rounded-xl border border-white/5 shadow-xl">
                        <h3 class="font-cinzel text-2xl font-bold mb-6 text-gold">InformaciÃ³n de Contacto</h3>
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <span class="text-2xl mr-4">ðŸ“</span>
                                <div>
                                    <h4 class="font-bold mb-1">DirecciÃ³n FÃ­sica</h4>
                                    <p class="opacity-80">Cra. 86b #47a-40, Barrio Floresta<br>MedellÃ­n, Antioquia, Colombia</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <span class="text-2xl mr-4">ðŸ“±</span>
                            ...
                            <div class="flex items-start">
                                <span class="text-2xl mr-4">ðŸ•’</span>
                                <div>
                                    <h4 class="font-bold mb-1">Horario de AtenciÃ³n</h4>
                                    <p class="opacity-80">Lunes a SÃ¡bado: 9:00 AM - 7:00 PM<br>Domingos: 10:00 AM - 3:00 PM</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <span class="text-2xl mr-4">ðŸšš</span>
                                <div>
                                    <h4 class="font-bold mb-1">EnvÃ­os</h4>
                                    <p class="opacity-80">Realizamos envÃ­os a nivel nacional. Entrega en MedellÃ­n en menos de 24 horas.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="bg-cardDark border-t border-white/5 py-12 mt-auto">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <p class="text-sm opacity-50">&copy; 2026 AMMAR PerfumerÃ­a. Todos los derechos reservados.</p>
        </div>
    </footer>
        ...
        <div class="bg-cardDark border border-white/10 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto flex flex-col md:flex-row relative transform scale-95 transition-transform duration-300 shadow-2xl">
            ...
            <div class="md:w-1/2 p-8 flex flex-col">
                ...
                <div class="space-y-4 mb-8 flex-grow">
                    <div>
                        <h4 class="text-gold text-sm font-bold uppercase tracking-wider mb-1">InspiraciÃ³n</h4>
                    ...
                    <div>
                        <h4 class="text-gold text-sm font-bold uppercase tracking-wider mb-1">TopologÃ­a Olfativa</h4>
    ...
    <script>
        ...
        function openModal(id) {{
            ...
            document.getElementById('modalPitch').textContent = p.pitch || 'Exclusiva fragancia de nuestra colecciÃ³n.';
            document.getElementById('modalNotes').textContent = p.notas || 'Consultar empaque.';
            document.getElementById('modalTopo').textContent = p.topologia || 'EvoluciÃ³n clÃ¡sica.';
            
            const msg = encodeURIComponent(`Â¡Hola! Me interesa la fragancia ${{p.nombre}} de ${{p.marca}} por ${{formatPrice(p.precio)}}. Â¿Tienen disponibilidad?`);
