...
foreach ($file in $files) {
    ...
    # Notice the anchors ^ and $ to ensure exact match of the string
    switch -Regex ($referencia) {
        ...
        "(?i)^Velvet Gold$" { 
            ...
            $tips = "Alternativa a Gentle Fluidity Gold (MFK). Dulce, atalcada y metálica."; break 
        }
        "(?i)^1 Million Lucky$" { 
            $gen = "Caballero"; $fam = "Amaderada"; 
            $not = "Ciruela, toronja, avellana, miel, cedro, flor de azahar, jazmín, pachulí.";
            $tips = "Muy codiciado. Destaca el acorde único de avellana con miel."; break 
        }
        "(?i)^Fame Blooming Pink$" { 
            ...
            $tips = "ADN tropical dominado por el mango jugoso, con jazmín e incienso."; break 
        }
        "(?i)^Fame$" { 
            $gen = "Dama"; $fam = "Almizclada Floral Amaderada"; 
            $not = "Mango, bergamota, jazmín, incienso de olíbano, vainilla y sándalo.";
        ...
        "(?i)^Invictus$" { 
            ...
            $tips = "Fundador de lo dulce/acuático. Sintético, deportivo, gran rendimiento."; break 
        }
        "(?i)^Phantom$" { 
            $gen = "Caballero"; $fam = "Aromática Fougère"; 
            $not = "Limón, lavanda, manzana, pachulí, tierra, vainilla, vetiver.";
            $tips = "Lavanda tradicional mezclada con tecnología y dulzor denso (terroso)."; break 
        }
        "(?i)^Delina Exclusif$" { 
            $gen = "Dama"; $fam = "Ámbar Floral"; 
            $not = "Bergamota, pera, lichi, rosa damascena, incienso, vetiver, vainilla, almizcle.";
            $tips = "Versión más densa, empolvada y dulce de la icónica rosa de Delina."; break 
        }
        "(?i)^Kalan$" { 
            $gen = "Caballero"; $fam = "Oriental Especiada"; 
            $not = "Naranja sanguina, pimienta negra, especias, lavanda, ajenjo, flor de azahar, cedro.";
            $tips = "Nicho polarizante. Terroso, seco, punzante (naranja sanguina y pimienta)."; break 
        }
        "(?i)^Marshmallow Blush$" { 
            $gen = "Dama"; $fam = "Floral Gourmand"; 
            $not = "Bergamota, toronja, frutas, coco, nardo, malvavisco, vainilla, almizcle.";
            $tips = "Extremadamente dulce, centrado exclusivamente en malvavisco/azúcar."; break 
        }
        "(?i)^Rose Rush$" { 
            $gen = "Dama"; $fam = "Floral Frutal"; 
            $not = "Pétalos de rosa, lichi, neroli, rosa de mayo, peonía, papaya, almizcle blanco.";
            $tips = "Accesible, fresca, acuática y centrada en una rosa juvenil."; break 
        }
        "(?i)^360$" { 
            $gen = "Dama"; $fam = "Floral"; 
            $not = "Melón, lirio, osmanto, mandarina, rosa, nenúfar, salvia, sándalo, vainilla.";
            $tips = "Clásico de los 90. Perfil altamente pulcro, limpio y floral/acuático."; break 
        }
        "(?i)^Paradoxe Intense$" { 
            $gen = "Dama"; $fam = "Floral Ámbar Amaderada"; 
            $not = "Neroli, Ambrofix y acorde de musgo.";
            $tips = "Sobredosis de flores blancas (neroli) con musgo para profundidad."; break 
        }
        "(?i)^Now Women$" { 
            $gen = "Dama"; $fam = "Floral Aldehídica"; 
            $not = "Té blanco, maracuyá, bergamota, aldehídos, flor de tiaré, jazmín, almizcle.";
            $tips = "Alternativa económica a Burberry Her. Fresa sintética atalcada."; break 
        }
        "(?i)^Tobacco Vanille$" { 
            $gen = "Unisex"; $fam = "Ámbar Especiada"; 
            $not = "Hoja de tabaco, especias, vainilla, cacao, haba tonka, frutos secos y maderas.";
            $tips = "Obra maestra. Picante del tabaco húmedo y dulzor resinoso (vainilla)."; break 
        }
        "(?i)^Tommy$" { 
            $gen = "Caballero"; $fam = "Cítrica Aromática"; 
            $not = "Bergamota, menta, lavanda, manzana, arándano, rosa, jazmín, algodón, maderas.";
            $tips = "Icono fresco y casual americano de los 90. Menta y manzana."; break 
        }
        "(?i)^Uomo Born In Roma( Set)?$" { 
            $gen = "Caballero"; $fam = "Amaderada Aromática / Mineral"; 
            $not = "Hojas de violeta, sal, jengibre, salvia, maderas y vetiver.";
            $tips = "Secado moderno y versátil. Juega con acordes minerales y dulzor fresco."; break 
        }
        "(?i)^Spicebomb$" { 
            $gen = "Caballero"; $fam = "Amaderada Especiada"; 
            $not = "Pimienta rosa, bergamota, toronja, canela, azafrán, cuero, tabaco y vetiver.";
            $tips = "'Bomba de especias'. Perfecto para el frío, picante y cálido a la vez."; break 
        }
        "(?i)^Libre$" { 
            $gen = "Dama"; $fam = "Ámbar Fougère"; 
            $not = "Lavanda, mandarina, bergamota, flor de azahar, jazmín, vainilla, haba tonka.";
            $tips = "Toma la lavanda masculina y la feminiza con flor de azahar y vainilla."; break 
        }
        "(?i)^Ajwad$" { 
            $gen = "Unisex"; $fam = "Amaderada Ámbar"; 
            $not = "Frutas, canela, bergamota, rosa, jazmín, ámbar, vainilla, almizcle, cedro, oud.";
            $tips = "Rendimiento extremo. Dulzor frutal metálico y rosa avainillada."; break 
        }
        "(?i)^Victoria$" { 
            $gen = "Dama"; $fam = "Floral Frutal"; 
            $not = "Flores silvestres, vainilla, sándalo.";
            $tips = "Aroma dulce y versátil femenino de Lattafa."; break 
        }
        "(?i)^Ombre Nomade$" { 
            $gen = "Unisex"; $fam = "Oriental Amaderada"; 
            $not = "Oud, rosa, incienso, frambuesa, azafrán, ámbar, benjuí, abedul y geranio.";
            $tips = "Opulencia pura. Cuero oscuro, oud potente y frambuesa de altísima estela."; break 
        }
        "(?i)^Odyssey Collection$" {
            $gen = "Unisex"; $fam = "Colección";
            $not = "Depende de la fragancia específica (Spectra, Mandarin, Mega, etc).";
            $tips = "Línea completa de Armaf con enfoques frescos, cítricos y frutales."; break
        }
        "(?i)^Art of Universe$" {
            $gen = "Unisex"; $fam = "Aromática Cítrica";
            $not = "Mandarina, bergamota, jengibre, menta, pera, flor de azahar, almizcle, ámbar y cedro.";
            $tips = "Limpio, cítrico y energizante. Alta duración."; break
        }
    }
...
Write-Host "Base de datos RE-reconstruida con Match exacto."
